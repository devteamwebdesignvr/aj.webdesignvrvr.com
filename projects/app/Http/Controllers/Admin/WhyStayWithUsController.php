...
use App\Models\WhyStayWithUs;
use App\Helper\Upload;
use Helper;

class WhyStayWithUsController extends Controller{
    
    public function __construct(WhyStayWithUs $model){
        $this->model=$model;
        $this->admin_base_url="why-stay-with-us.index";
        $this->admin_view="admin.why-stay-with-us";
    }
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile("image")) {
            $data['image'] = Upload::fileUpload($request->file("image"),"why-stay-with-us");
        }
        if ($request->hasFile("bannerImage")) {
            $data['bannerImage'] = Upload::fileUpload($request->file("bannerImage"),"why-stay-with-us");
        }
