...
class AccommodationController extends Controller{
    ...
    public function __construct(Accommodation $model){
        $this->model=$model;
        $this->admin_base_url="accommodations.index";
        $this->admin_view="admin.accommodations";
    }
    ...
    public function store(Request $request){
        ...
        if ($request->hasFile("image")) {
            $data['image'] = Upload::fileUpload($request->file("image"),"Accommodation");
        }
        if ($request->hasFile("bannerImage")) {
            $data['bannerImage'] = Upload::fileUpload($request->file("bannerImage"),"Accommodation");
        }
