			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<div><span style="display: block; font-size: 30px; font-weight: 600; margin: 20px 0 10px 0; color: #222222;">Review</span></div>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<h4 style="font-size: 17px; color: #222; font-weight: 600">Hey {{$data['name']}},</h4>

						<p style=" font-size: 15px; color: #454545; line-height: 24px; font-weight: 400; margin: 0 0 15px 0; text-align: left">Review.</p>
						...
						<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr>
									<td align="center" style="padding: 10px;" valign="top"><strong>We hope you had a great stay. Please leave us a review</strong></td>
								
								</tr>
								<tr>
									<td align="center" style="padding: 10px;" valign="top"><strong>	Click here to leave a review for <a href="{{ url('properties/detail/'.$property->seo_url) }}">Link</a></strong></td>
