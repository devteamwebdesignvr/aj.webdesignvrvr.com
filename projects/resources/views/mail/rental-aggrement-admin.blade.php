			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<div><span style="display: block; font-size: 30px; font-weight: 600; margin: 20px 0 10px 0; color: #62ade4; font-family: 'Poppins', sans-serif;">New Rental Agreement</span></div>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<p style=" font-size: 15px; color: #000; line-height: 24px; font-weight: 400; margin: 0 0 15px 0; text-align: left; font-family: 'Poppins', sans-serif;">You have received a copy of Rental Agreement.</p>
						...
						<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #62ade4;" valign="top"><strong>Rental Agreement Signature :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000;" valign="top">
								...
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #62ade4;" valign="top"><strong>Rental Agreement Image :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000;" valign="top">
