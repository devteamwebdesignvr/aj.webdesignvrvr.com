			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<div><span style="display: block; font-size: 30px; font-weight: 600; margin: 20px 0 10px 0; color: #62ade4; font-family: 'Poppins', sans-serif;">Payment Reminder.</span></div>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
				<tbody>
					<tr>
						...
						<p style=" font-size: 15px; color: #000; line-height: 24px; font-weight: 400; margin: 0 0 15px 0; text-align: left; font-family: 'Poppins', sans-serif;">Your booking's payment reminder.</p>
						...
						<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
							<tbody>
								...
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #62ade4;" valign="top"><strong>Signature :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000;" valign="top">
								...
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #62ade4;" valign="top"><strong>Image :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000;" valign="top">
										<img src="{{asset($data['rental_aggrement_images'])}}" style="width:160px;height:100px;" />
									</td>
								</tr>
								@endif
									@if($data['rental_agreement_link'])
								<tr>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000; border-right:0px solid #62ade4;" valign="top"><strong>Rental Agreement Link :</strong></td>
									<td align="left" style="padding: 10px; border: 1px solid #62ade4; font-weight: bold; font-size: 15px; color:#000;" valign="top">
										<a href="{{asset($data['rental_agreement_link'])}}"  > Click Here</a>
									</td>
								</tr>
								@endif
							</tbody>
						...
						@include("mail.booking-common-data")
							<div style="text-align: center;"><a href="{{ url('booking/payment/paypal/'.$data['id']) }}" style="background: #00a9dd;
                         color: #fff;
