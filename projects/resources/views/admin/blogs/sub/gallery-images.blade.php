...
@php //dd(ModelHelper::getImageByBlog($data->id)); @endphp
@if(isset($data))	
	@if(count(ModelHelper::getImageByBlog($data->id))>0)
  	<div id="gallery">
        ...
        <div id="txtresponse" class="text-success"> </div>
         <div id="submit-container"> 
            ...
            <div class="row" id="image-list" >
                ...
                @foreach(ModelHelper::getImageByBlog($data->id) as $image)
                    ...
                    <div class="col-md-3 " >
                    	<div class="gaurav-class" id="image_{{ (($image->id)) }}">
				            ...
				            <a href="javaScript:void(0)" class="text-danger delete-image-blog" data-id="{{ $image->id }}"> <i class="fa fa-times"></i> Delete</a>
