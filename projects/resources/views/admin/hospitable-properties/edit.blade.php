        ...
        <div class="col-12">
          ...
          <div class="card  ">
            <div class="card-header">
              <h3 class="card-title">Edit {{ Str::singular($name) }} :-  {{ $data->name  }}</h3>
...
@parent
<script>
    CKEDITOR.replace( 'custom_description',{ allowedContent:true,filebrowserUploadUrl: "{{route('ckeditor.upload', ['_token' => csrf_token() ])}}",
