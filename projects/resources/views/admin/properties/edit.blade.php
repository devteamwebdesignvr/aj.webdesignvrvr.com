  ...
  $(document).on("click",".add-fee-data",function(){
        html=`
            <div class="row gaurav-delete-property">
                ...
                <div class="col-md-2">
                    {!! Form::text("fee_rate[]",null,["required","class"=>"form-control","placeholder"=>"Fee Rate","pattern"=>"^[1-9]\d*(\.\d+)?$","title"=>"please enter number only" ]) !!}
                </div>
                <div class="col-md-2">
                    {!! Form::select("fee_type[]",["Percentage"=>"Percentage","Excat"=>"Amount "],null,["required","class"=>"form-control"]) !!}
                </div>
                <div class="col-md-2">
                    {!! Form::select("fee_apply[]",["total"=>"Not Taxable","gross"=>"Taxable"],null,["required","class"=>"form-control"]) !!}
                </div>
                <div class="col-md-2">
